...
_SETTINGS = {
	"arm64-apple-ios-simulator BazelSample.app/BazelSample": {
		"c": "-iquote$(PROJECT_DIR) -iquote$(PROJECT_DIR)/bazel-out/ios_sim_arm64-dbg-ios-sim_arm64-min17.0-applebin_ios-ST-62a007c7bf0c/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all"
	}
}
